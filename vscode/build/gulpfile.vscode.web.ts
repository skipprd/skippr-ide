...
const minifyVSCodeWebTask = task.define('minify-vscode-web-OLD', task.series(
	...
	optimize.minifyTask('out-vscode-web', `https://skippr.com/ide-sourcemaps/sourcemaps/${commit}/core`)
));
gulp.task(minifyVSCodeWebTask);

// esbuild-based tasks (new)
const sourceMappingURLBase = `https://skippr.com/ide-sourcemaps/sourcemaps/${commit}`;
