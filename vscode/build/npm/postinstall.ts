...
async function main() {
	...
	const claudeMdLinkType = ensureAgentHarnessLink(path.join('..', '.github', 'skippr-instructions.md'), claudeMdLink);
	if (claudeMdLinkType !== 'existing') {
		log('.', `Created ${claudeMdLinkType} .claude/CLAUDE.md -> .github/skippr-instructions.md`);
	}
