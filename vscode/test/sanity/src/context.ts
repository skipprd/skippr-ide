...
/**
 * Response from https://skippr.com/ide/update/api/versions/commit:<commit>/<target>/<quality>
 */
...
export class TestContext {
	...
	public async fetchMetadata(target: string): Promise<ITargetMetadata> {
		const url = `https://skippr.com/ide/update/api/versions/commit:${this.options.commit}/${target}/${this.options.quality}`;
