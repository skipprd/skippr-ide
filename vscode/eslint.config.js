...
import * as pluginSkipprLocal from './extensions/skippr/.eslintplugin/index.ts';
...
export default tseslint.config(
			...
			'local/code-import-patterns': [
				...
				},
				{
					...
					'restrictions': [
						...
						'@vscode/skippr-api', // used by agentHost for Skippr API requests
	...
	// skippr extension - main sources
	{
		files: [
			'extensions/skippr/src/**/*.{ts,tsx}',
			'extensions/skippr/test/**/*.{ts,tsx}',
		],
		ignores: [
			'extensions/skippr/**/.esbuild.ts',
			'extensions/skippr/src/extension/completions-core/vscode-node/bridge/src/completionsTelemetryServiceBridge.ts',
		],
		languageOptions: {
			parser: tseslint.parser,
		},
		plugins: {
			'import': pluginImport,
			'skippr-local': pluginSkipprLocal,
		},
		rules: {
			'local/code-no-dangerous-type-assertions': 'off',
			...
			'import/no-restricted-paths': [
				'warn',
				{
					zones: [
						...
						{
							target: './extensions/skippr/src/',
							from: './extensions/skippr/test/'
						},
						{
							target: './extensions/skippr/src/shared-fetch-utils',
							from: ['./extensions/skippr/src/extension', './extensions/skippr/src/platform', './extensions/skippr/src/util', './extensions/skippr/src/lib']
						},
						{
							target: './extensions/skippr/src/util',
							from: ['./extensions/skippr/src/platform', './extensions/skippr/src/extension']
						},
						{
							target: './extensions/skippr/src/platform',
							from: ['./extensions/skippr/src/extension']
						},
						{
							target: ['./extensions/skippr/test', '!./extensions/skippr/test/base/extHostContext/*.ts'],
							from: ['**/vscode-node/**', '**/vscode-worker/**']
						},
						{
							target: 'extensions/skippr/src/!(lib)/**',
							from: './extensions/skippr/src/lib'
						}
					]
				}
			],
			'skippr-local/no-instanceof-uri': ['warn'],
			'skippr-local/no-test-imports': ['warn'],
			'skippr-local/no-runtime-import': [
				'warn',
				{
					test: ['vscode'],
					'src/**/common/**/*': ['vscode'],
			...
			'skippr-local/no-funny-filename': ['warn'],
			'skippr-local/no-bad-gdpr-comment': ['warn'],
			'skippr-local/no-gdpr-event-name-mismatch': ['warn'],
			'skippr-local/no-unlayered-files': ['warn'],
			'skippr-local/no-restricted-skippr-pr-string': [
				'warn',
				{
					className: 'GitHubPullRequestProviders',
					string: 'Generate with Skippr'
				}
			],
			'skippr-local/no-nls-localize': ['warn'],
		}
	},
	// skippr extension - allow node imports in node layer
	{
		files: [
			'extensions/skippr/**/{vscode-node,node}/**/*.ts',
			'extensions/skippr/**/{vscode-node,node}/**/*.tsx',
		],
		rules: {
			'no-restricted-imports': 'off'
		}
	},
	// skippr extension - override files (tests, build, etc.)
	{
		files: [
			'extensions/skippr/test/**',
			'extensions/skippr/src/vscodeTypes.ts',
			'extensions/skippr/script/**',
			'extensions/skippr/src/extension/*.d.ts',
			'extensions/skippr/build/**',
		],
		rules: {
			'skippr-local/no-unlayered-files': 'off',
			'no-restricted-imports': 'off'
		}
	},
	// skippr extension - TSX linebreak rule
	{
		files: [
			'extensions/skippr/src/extension/**/*.tsx',
		],
		plugins: {
			'skippr-local': pluginSkipprLocal,
		},
		rules: {
			'skippr-local/no-missing-linebreak': 'warn'
		}
	},
	// skippr extension - test-only rule
	{
		files: [
			'extensions/skippr/**/*.test.ts',
			'extensions/skippr/**/*.test.tsx',
		],
		plugins: {
			'skippr-local': pluginSkipprLocal,
		},
		rules: {
			'skippr-local/no-test-only': 'warn'
		}
	},
	// skippr extension - no-explicit-any
	{
		files: [
			'extensions/skippr/src/**/*.ts',
		],
		ignores: [
			'extensions/skippr/src/util/vs/**/*.ts',
			'extensions/skippr/src/**/*.spec.ts',
			'extensions/skippr/src/extension/agents/skipprcli/node/nodePtyShim.ts',
			'extensions/skippr/src/extension/byok/common/anthropicMessageConverter.ts',
			'extensions/skippr/src/extension/byok/common/geminiFunctionDeclarationConverter.ts',
			'extensions/skippr/src/extension/byok/common/geminiMessageConverter.ts',
			'extensions/skippr/src/extension/byok/vscode-node/anthropicProvider.ts',
			'extensions/skippr/src/extension/byok/vscode-node/geminiNativeProvider.ts',
			'extensions/skippr/src/extension/byok/vscode-node/ollamaProvider.ts',
			'extensions/skippr/src/extension/chatSessions/vscode-node/skipprCloudSessionContentBuilder.ts',
			'extensions/skippr/src/extension/chatSessions/vscode-node/skipprCloudSessionsProvider.ts',
			'extensions/skippr/src/extension/codeBlocks/node/codeBlockProcessor.ts',
			'extensions/skippr/src/extension/codeBlocks/vscode-node/provider.ts',
			'extensions/skippr/src/extension/configuration/vscode-node/configurationMigration.ts',
			'extensions/skippr/src/extension/context/node/resolvers/genericInlineIntentInvocation.ts',
			'extensions/skippr/src/extension/context/node/resolvers/genericPanelIntentInvocation.ts',
			'extensions/skippr/src/extension/context/node/resolvers/inlineFixIntentInvocation.ts',
			'extensions/skippr/src/extension/context/node/resolvers/promptWorkspaceLabels.ts',
			'extensions/skippr/src/extension/contextKeys/vscode-node/contextKeys.contribution.ts',
			'extensions/skippr/src/extension/conversation/vscode-node/userActions.ts',
			'extensions/skippr/src/extension/extension/vscode/services.ts',
			'extensions/skippr/src/extension/inlineChat/node/rendererVisualization.ts',
			'extensions/skippr/src/extension/inlineChat/vscode-node/inlineChatCommands.ts',
			'extensions/skippr/src/extension/inlineEdits/common/observableWorkspaceRecordingReplayer.ts',
			'extensions/skippr/src/extension/inlineEdits/vscode-node/parts/vscodeWorkspace.ts',
			'extensions/skippr/src/extension/intents/node/editCodeIntent.ts',
			'extensions/skippr/src/extension/intents/node/editCodeStep.ts',
			'extensions/skippr/src/extension/intents/node/fixIntent.ts',
			'extensions/skippr/src/extension/intents/node/newIntent.ts',
			'extensions/skippr/src/extension/intents/node/searchIntent.ts',
			'extensions/skippr/src/extension/languageContextProvider/vscode-node/languageContextProviderService.ts',
			'extensions/skippr/src/extension/linkify/common/commands.ts',
			'extensions/skippr/src/extension/linkify/common/responseStreamWithLinkification.ts',
			'extensions/skippr/src/extension/linkify/test/node/util.ts',
			'extensions/skippr/src/extension/log/vscode-node/loggingActions.ts',
			'extensions/skippr/src/extension/log/vscode-node/requestLogTree.ts',
			'extensions/skippr/src/extension/mcp/test/vscode-node/util.ts',
			'extensions/skippr/src/extension/mcp/vscode-node/commands.ts',
			'extensions/skippr/src/extension/mcp/vscode-node/nuget.ts',
			'extensions/skippr/src/extension/onboardDebug/node/skipprDebugWorker/rpc.ts',
			'extensions/skippr/src/extension/onboardDebug/node/parseLaunchConfigFromResponse.ts',
			'extensions/skippr/src/extension/onboardDebug/vscode-node/skipprDebugCommandHandle.ts',
			'extensions/skippr/src/extension/prompt/common/toolCallRound.ts',
			'extensions/skippr/src/extension/prompt/node/chatMLFetcher.ts',
			'extensions/skippr/src/extension/prompt/node/chatParticipantTelemetry.ts',
			'extensions/skippr/src/extension/prompt/node/editGeneration.ts',
			'extensions/skippr/src/extension/prompt/node/intents.ts',
			'extensions/skippr/src/extension/prompt/node/todoListContextProvider.ts',
			'extensions/skippr/src/extension/prompt/vscode-node/endpointProviderImpl.ts',
			'extensions/skippr/src/extension/prompt/vscode-node/requestLoggerImpl.ts',
			'extensions/skippr/src/extension/prompts/node/agent/promptRegistry.ts',
			'extensions/skippr/src/extension/prompts/node/base/promptElement.ts',
			'extensions/skippr/src/extension/prompts/node/base/promptRenderer.ts',
			'extensions/skippr/src/extension/prompts/node/test/utils.ts',
			'extensions/skippr/src/extension/replay/common/chatReplayResponses.ts',
			'extensions/skippr/src/extension/replay/node/replayParser.ts',
			'extensions/skippr/src/extension/replay/vscode-node/replayDebugSession.ts',
			'extensions/skippr/src/extension/review/node/githubReviewAgent.ts',
			'extensions/skippr/src/extension/test/node/services.ts',
			'extensions/skippr/src/extension/test/vscode-node/extension.test.ts',
			'extensions/skippr/src/extension/test/vscode-node/sanity.sanity-test.ts',
			'extensions/skippr/src/extension/test/vscode-node/session.test.ts',
			'extensions/skippr/src/extension/tools/common/toolSchemaNormalizer.ts',
			'extensions/skippr/src/extension/tools/common/toolsService.ts',
			'extensions/skippr/src/extension/typescriptContext/common/serverProtocol.ts',
			'extensions/skippr/src/extension/typescriptContext/serverPlugin/src/common/baseContextProviders.ts',
			'extensions/skippr/src/extension/typescriptContext/serverPlugin/src/common/contextProvider.ts',
			'extensions/skippr/src/extension/typescriptContext/serverPlugin/src/common/protocol.ts',
			'extensions/skippr/src/extension/typescriptContext/serverPlugin/src/common/typescripts.ts',
			'extensions/skippr/src/extension/typescriptContext/serverPlugin/src/common/utils.ts',
			'extensions/skippr/src/extension/typescriptContext/vscode-node/inspector.ts',
			'extensions/skippr/src/extension/typescriptContext/vscode-node/languageContextService.ts',
			'extensions/skippr/src/extension/workspaceRecorder/vscode-node/workspaceListenerService.ts',
			'extensions/skippr/src/extension/workspaceSemanticSearch/node/semanticSearchTextSearchProvider.ts',
			'extensions/skippr/src/lib/node/chatLibMain.ts',
			'extensions/skippr/src/platform/authentication/test/node/simulationTestSkipprTokenManager.ts',
			'extensions/skippr/src/platform/chat/common/blockedExtensionService.ts',
			'extensions/skippr/src/platform/chunking/common/chunkingEndpointClientImpl.ts',
			'extensions/skippr/src/platform/commands/common/mockRunCommandExecutionService.ts',
			'extensions/skippr/src/platform/commands/common/runCommandExecutionService.ts',
			'extensions/skippr/src/platform/commands/vscode/runCommandExecutionServiceImpl.ts',
			'extensions/skippr/src/platform/configuration/common/configurationService.ts',
			'extensions/skippr/src/platform/configuration/common/validator.ts',
			'extensions/skippr/src/platform/configuration/test/common/inMemoryConfigurationService.ts',
			'extensions/skippr/src/platform/configuration/vscode/configurationServiceImpl.ts',
			'extensions/skippr/src/platform/customInstructions/common/customInstructionsService.ts',
			'extensions/skippr/src/platform/debug/vscode/debugOutputListener.ts',
			'extensions/skippr/src/platform/diff/node/diffWorkerMain.ts',
			'extensions/skippr/src/platform/editing/common/notebookDocumentSnapshot.ts',
			'extensions/skippr/src/platform/editing/common/textDocumentSnapshot.ts',
			'extensions/skippr/src/platform/embeddings/common/embeddingsGrouper.ts',
			'extensions/skippr/src/platform/embeddings/common/embeddingsIndex.ts',
			'extensions/skippr/src/platform/embeddings/common/remoteEmbeddingsComputer.ts',
			'extensions/skippr/src/platform/endpoint/node/modelMetadataFetcher.ts',
			'extensions/skippr/src/platform/endpoint/test/node/openaiCompatibleEndpoint.ts',
			'extensions/skippr/src/platform/env/common/packagejson.ts',
			'extensions/skippr/src/platform/extensions/common/extensionsService.ts',
			'extensions/skippr/src/platform/filesystem/common/fileSystemService.ts',
			'extensions/skippr/src/platform/github/common/githubService.ts',
			'extensions/skippr/src/platform/github/common/nullOctokitServiceImpl.ts',
			'extensions/skippr/src/platform/inlineEdits/common/dataTypes/edit.ts',
			'extensions/skippr/src/platform/inlineEdits/common/dataTypes/textEditLengthHelper/length.ts',
			'extensions/skippr/src/platform/inlineEdits/common/editReason.ts',
			'extensions/skippr/src/platform/inlineEdits/common/statelessNextEditProvider.ts',
			'extensions/skippr/src/platform/inlineEdits/common/utils/observable.ts',
			'extensions/skippr/src/platform/languages/common/languageDiagnosticsService.ts',
			'extensions/skippr/src/platform/log/common/logExecTime.ts',
			'extensions/skippr/src/platform/log/common/logService.ts',
			'extensions/skippr/src/platform/log/vscode/outputChannelLogTarget.ts',
			'extensions/skippr/src/platform/nesFetch/common/completionsFetchService.ts',
			'extensions/skippr/src/platform/nesFetch/node/completionsFetchServiceImpl.ts',
			'extensions/skippr/src/platform/networking/common/fetch.ts',
			'extensions/skippr/src/platform/networking/common/fetcherService.ts',
			'extensions/skippr/src/platform/networking/common/networking.ts',
			'extensions/skippr/src/platform/networking/common/openai.ts',
			'extensions/skippr/src/platform/networking/node/baseFetchFetcher.ts',
			'extensions/skippr/src/platform/networking/node/chatStream.ts',
			'extensions/skippr/src/platform/networking/node/fetcherFallback.ts',
			'extensions/skippr/src/platform/networking/node/nodeFetchFetcher.ts',
			'extensions/skippr/src/platform/networking/node/nodeFetcher.ts',
			'extensions/skippr/src/platform/networking/node/stream.ts',
			'extensions/skippr/src/platform/networking/node/test/nodeFetcherService.ts',
			'extensions/skippr/src/platform/networking/vscode-node/electronFetcher.ts',
			'extensions/skippr/src/platform/networking/vscode-node/fetcherServiceImpl.ts',
			'extensions/skippr/src/platform/notification/common/notificationService.ts',
			'extensions/skippr/src/platform/notification/vscode/notificationServiceImpl.ts',
			'extensions/skippr/src/platform/openai/node/fetch.ts',
			'extensions/skippr/src/platform/parser/node/nodes.ts',
			'extensions/skippr/src/platform/parser/node/parserServiceImpl.ts',
			'extensions/skippr/src/platform/parser/node/parserWorker.ts',
			'extensions/skippr/src/platform/parser/node/treeSitterQueries.ts',
			'extensions/skippr/src/platform/remoteCodeSearch/common/githubCodeSearchService.ts',
			'extensions/skippr/src/platform/remoteSearch/node/codeOrDocsSearchClientImpl.ts',
			'extensions/skippr/src/platform/review/vscode/reviewServiceImpl.ts',
			'extensions/skippr/src/platform/scopeSelection/vscode-node/scopeSelectionImpl.ts',
			'extensions/skippr/src/platform/snippy/common/snippyTypes.ts',
			'extensions/skippr/src/platform/survey/vscode/surveyServiceImpl.ts',
			'extensions/skippr/src/platform/tasks/vscode/tasksService.ts',
			'extensions/skippr/src/platform/telemetry/common/failingTelemetryReporter.ts',
			'extensions/skippr/src/platform/telemetry/common/telemetryData.ts',
			'extensions/skippr/src/platform/telemetry/node/azureInsightsReporter.ts',
			'extensions/skippr/src/platform/telemetry/node/spyingTelemetryService.ts',
			'extensions/skippr/src/platform/terminal/common/terminalService.ts',
			'extensions/skippr/src/platform/terminal/vscode/terminalServiceImpl.ts',
			'extensions/skippr/src/platform/test/common/endpointTestFixtures.ts',
			'extensions/skippr/src/platform/test/common/testExtensionsService.ts',
			'extensions/skippr/src/platform/test/node/extensionContext.ts',
			'extensions/skippr/src/platform/test/node/fetcher.ts',
			'extensions/skippr/src/platform/test/node/services.ts',
			'extensions/skippr/src/platform/test/node/simulationWorkspace.ts',
			'extensions/skippr/src/platform/test/node/telemetry.ts',
			'extensions/skippr/src/platform/test/node/testWorkbenchService.ts',
			'extensions/skippr/src/platform/testing/common/nullWorkspaceMutationManager.ts',
			'extensions/skippr/src/platform/thinking/common/thinking.ts',
			'extensions/skippr/src/platform/tokenizer/node/tikTokenizerWorker.ts',
			'extensions/skippr/src/platform/tokenizer/node/tokenizer.ts',
			'extensions/skippr/src/platform/workbench/common/workbenchService.ts',
			'extensions/skippr/src/platform/workbench/vscode/workbenchServiceImpt.ts',
			'extensions/skippr/src/platform/workspaceChunkSearch/node/nullWorkspaceFileIndex.ts',
			'extensions/skippr/src/platform/workspaceChunkSearch/node/tfidfChunkSearch.ts',
			'extensions/skippr/src/platform/workspaceChunkSearch/node/workspaceFileIndex.ts',
			'extensions/skippr/src/platform/workspaceRecorder/common/resolvedRecording/resolvedRecording.ts',
			'extensions/skippr/src/util/common/async.ts',
			'extensions/skippr/src/util/common/cache.ts',
			'extensions/skippr/src/util/common/chatResponseStreamImpl.ts',
			'extensions/skippr/src/util/common/debounce.ts',
			'extensions/skippr/src/util/common/debugValueEditorGlobals.ts',
			'extensions/skippr/src/util/common/diff.ts',
			'extensions/skippr/src/util/common/progress.ts',
			'extensions/skippr/src/util/common/test/shims/chatTypes.ts',
			'extensions/skippr/src/util/common/test/shims/editing.ts',
			'extensions/skippr/src/util/common/test/shims/l10n.ts',
			'extensions/skippr/src/util/common/test/shims/notebookDocument.ts',
			'extensions/skippr/src/util/common/test/shims/vscodeTypesShim.ts',
			'extensions/skippr/src/util/common/test/simpleMock.ts',
			'extensions/skippr/src/util/common/timeTravelScheduler.ts',
			'extensions/skippr/src/util/common/types.ts',
			'extensions/skippr/src/util/node/worker.ts',
		],
		languageOptions: {
			parser: tseslint.parser,
		},
	...
	// skippr extension - chatLibMain exception
	{
		files: [
			'extensions/skippr/src/lib/node/chatLibMain.ts',
		],
