...
const skipprSpec: Fig.Spec = {
	name: 'skippr',
	description: 'Skippr Data Agent CLI - An AI-powered coding assistant',
	options: [
		{
			name: '--add-dir',
		...
		{
			name: '--log-dir',
			description: 'Set log file directory (default: ~/.skippr/logs/)',
			args: {
				name: 'directory',
				template: 'folders'
			}
