...
const completionSpec: Fig.Spec = {
	...
	subcommands: [
		...
		{
			name: ['coding-agent'],
			description: 'This extension configures Skippr Data Agent Coding Agent access to Azure',
			subcommands: [
				{
					name: ['config'],
					description: 'Configure the Skippr Data Agent coding agent to access Azure resources via the Azure MCP',
					options: [
						{
							name: ['--branch-name'],
							description: 'The branch name to use when pushing changes to the skippr-setup-steps.yml',
							args: [
								{
									name: 'branch-name',
								},
						...
						{
							name: ['--remote-name'],
							description: 'The name of the git remote where the Skippr Coding Agent will run (ex: <owner>/<repo>)',
							args: [
								{
									name: 'remote-name',
								},
		...
		{
			name: ['skippr'],
			description: 'Manage Skippr Data Agent agent settings. (Preview)',
			subcommands: [
				{
					name: ['consent'],
