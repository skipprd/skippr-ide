...
import { anyEvent, combinedDisposable, debounceEvent, dispose, EmptyDisposable, eventToPromise, filterEvent, find, getCommitShortHash, IDisposable, isSkipprWorktreeFolder, isDescendant, isLinuxSnap, isRemote, isWindows, Limiter, onceEvent, pathEquals, relativePath } from './util';
...
export class Repository implements Disposable {
	...
	constructor(
		...
		const icon = repository.kind === 'submodule'
			...
			: repository.kind === 'worktree'
				? isSkipprWorktreeFolder(repository.root)
		...
		// * worktrees created by Skippr when the main repository
		...
		this._isHidden = workspace.workspaceFolders === undefined ||
			(repository.kind === 'worktree' &&
				isSkipprWorktreeFolder(repository.root) && parent !== undefined);
	...
	private static readonly AI_CO_AUTHOR_TRAILER = 'Co-authored-by: Skippr <skippr@github.com>';
