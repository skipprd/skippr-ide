...
export class AutoFetcher {
	...
	private async onFirstGoodRemoteOperation(): Promise<void> {
		...
		const result = await window.showInformationMessage(l10n.t('Would you like {0} to [periodically run "git fetch"]({1})?', env.appName, 'https://skippr.com/go/fwlink/?linkid=865294'), yes, no, askLater);
