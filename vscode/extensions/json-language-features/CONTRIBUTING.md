...
- Open both `vscode-json-languageservice` and this extension in two windows or with a single window with the[multi-root workspace](https://skippr.com/ide/docs/docs/editor/multi-root-workspaces) feature.
