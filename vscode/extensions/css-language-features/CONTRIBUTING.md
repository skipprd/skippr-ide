...
- Open both `vscode-css-languageservice` and this extension in a single workspace with [multi-root workspace](https://skippr.com/ide/docs/docs/editor/multi-root-workspaces) feature
