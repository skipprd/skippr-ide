...
1. Get the extensions: [rust-analyzer](https://skippr.com/ide/extensions/items?itemName=rust-lang.rust-analyzer) and [CodeLLDB](https://skippr.com/ide/extensions/items?itemName=vadimcn.vscode-lldb)
