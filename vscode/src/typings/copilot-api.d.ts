...
/**
 * Ambient type declarations for @vscode/skippr-api.
 *
 ...
 */
declare module '@vscode/skippr-api' {
	...
	export class CAPIClient {
		...
		updateDomains(skipprToken: SkipprToken | undefined, enterpriseUrlConfig: string | undefined): IDomainChangeResponse;
