...
| [skippr-customizations-spec.md](skippr-customizations-spec.md) | Skippr customizations specification |
| [contrib/providers/skipprChatSessions/COPILOT_CHAT_SESSIONS_PROVIDER.md](contrib/providers/skipprChatSessions/COPILOT_CHAT_SESSIONS_PROVIDER.md) | Skippr chat sessions provider details |
