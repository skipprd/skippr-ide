...
export interface ISessionType {
	/** Unique identifier (e.g., 'skippr-cli', 'skippr-cloud', 'claude-code'). */
	readonly id: string;
	/** Display label (e.g., 'Skippr Agent', 'Cloud'). */
 ...
 * Skippr chat sessions). Consumers that only have a provider id and a
