...
import { openSkipprCliStateFile } from '../../../../../workbench/contrib/chat/browser/actions/openSkipprCliStateFileAction.js';
import { ISessionsManagementService } from '../../../../services/sessions/common/sessionsManagement.js';
import { IsAgentHostSession } from './agentHostSkillButtons.js';

/**
 * Sessions-app variant of "Open Skippr Agent State File". Uses the Agents
 * window's `ISessionsManagementService.activeSession` to find the active
 * Skippr Agent session, then defers to the shared workbench helper for
 * the actual resolution and editor opening.
 *
 * The vscode workbench registers a separate action class
 * (`OpenSkipprCliStateFileAction` in
 * `workbench/contrib/chat/browser/actions/openSkipprCliStateFileAction.ts`)
