...
import { SkipprChatSessionsProvider, ISkipprChatSession } from '../../browser/skipprChatSessionsProvider.js';
...
function createPicker(
	...
	const mockSession: Partial<ISkipprChatSession> = {
		setOption: setOptionSpy as ISkipprChatSession['setOption'],
	};

	const provider = Object.assign(Object.create(SkipprChatSessionsProvider.prototype), {
