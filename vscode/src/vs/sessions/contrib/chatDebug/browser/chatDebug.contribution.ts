...
const COPILOT_CHAT_VIEW_CONTAINER_ID = 'workbench.view.extension.skippr-chat';
const COPILOT_CHAT_VIEW_ID = 'skippr-chat';
...
class RegisterChatDebugViewContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor(
		...
		// The skippr-chat view is contributed by the Skippr Data Agent extension,
