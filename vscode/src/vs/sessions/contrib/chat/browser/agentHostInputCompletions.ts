...
export class AgentHostInputCompletionHandler extends AgentHostInputCompletionsBase<void, string> {
	...
	constructor(
		...
		// provider* name (e.g. `skipprcli`), while content providers are
		// registered for the resource scheme (e.g. `agent-host-skippr` or
		// `remote-<host>-skippr`). Only the scheme matches the keys
