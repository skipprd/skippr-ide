...
- **Provider icon** — the session type icon (e.g. Skippr Agent, Cloud)
...
Shows the signed-in GitHub profile image (falls back to the account codicon). Clicking opens a combined account and Skippr status panel with sign-in/sign-out and settings actions.
