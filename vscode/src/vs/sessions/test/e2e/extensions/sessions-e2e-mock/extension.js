...
/**
 * Registers mock command handlers that stand in for the real Skippr Data Agent
...
function registerMockCommands(vscode) {
	...
	disposables.push(vscode.commands.registerCommand(
		'skippr.data-agent.chat.createPullRequestSkipprCLIAgentSession.createPR',
		() => {
	...
	disposables.push(vscode.commands.registerCommand(
		'skippr.data-agent.chat.openPullRequestSkipprCLIAgentSession.openPR',
		() => {
	...
	disposables.push(vscode.commands.registerCommand(
		'skippr.data-agent.chat.mergeSkipprCLIAgentSessionChanges.merge',
		() => {
	...
	disposables.push(vscode.commands.registerCommand(
		'skippr.data-agent.chat.mergeSkipprCLIAgentSessionChanges.mergeAndSync',
		() => {
	...
	disposables.push(vscode.commands.registerCommand(
		'skippr.data-agent.chat.applySkipprCLIAgentSessionChanges.apply',
		() => {
	...
	disposables.push(vscode.commands.registerCommand(
		'skippr.data-agent.chat.checkoutPullRequestReroute',
		() => {
	...
	disposables.push(vscode.commands.registerCommand(
		'skippr.data-agent.chat.updateSkipprCLIAgentSessionChanges.update',
		() => {
