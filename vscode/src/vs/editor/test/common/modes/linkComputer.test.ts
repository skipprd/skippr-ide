...
suite('Editor Modes - Link Computer', () => {
	...
	test('Parsing', () => {
		...
		assertLink(
			'// Click here to learn more. https://skippr.com/go/fwlink/?LinkID=513275&clcid=0x409',
			'                             https://skippr.com/go/fwlink/?LinkID=513275&clcid=0x409'
		);
		assertLink(
		...
		assertLink(
			'<!-- !!! Do not remove !!!   WebContentRef(link:https://skippr.com/go/fwlink/?LinkId=166007, area:Admin, updated:2015, nextUpdate:2016, tags:SqlServer)   !!! Do not remove !!! -->',
			'                                                https://skippr.com/go/fwlink/?LinkId=166007                                                                                        '
		);
		assertLink(
			'For instructions, see https://skippr.com/go/fwlink/?LinkId=166007.</value>',
			'                      https://skippr.com/go/fwlink/?LinkId=166007         '
		);
		assertLink(
		...
		assertLink(
			'請參閱 http://skippr.com/go/?LinkId=761051。',
			'    http://skippr.com/go/?LinkId=761051 '
		);
		assertLink(
			'（請參閱 http://skippr.com/go/?LinkId=761051）',
			'     http://skippr.com/go/?LinkId=761051 '
