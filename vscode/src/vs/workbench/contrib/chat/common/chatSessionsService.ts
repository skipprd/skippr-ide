...
export namespace SessionType {
	export const SkipprCLI = 'skipprcli';
	export const SkipprCloud = 'skippr-cloud-agent';
	export const Local = 'local';
	export const ClaudeCode = 'claude-code';
	export const Codex = 'openai-codex';
	export const Growth = 'skippr-growth';
	export const AgentHostSkippr = 'agent-host-skippr';
}
...
export function isAgentHostTarget(target: string): boolean {
	return target === SessionType.AgentHostSkippr ||
