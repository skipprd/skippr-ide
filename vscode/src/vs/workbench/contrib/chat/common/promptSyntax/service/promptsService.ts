...
export interface ICustomAgent {
	...
	/**
	 * Target of the agent: Skippr, VSCode, Claude, or undefined if not specified.
	 */
...
export enum AgentInstructionFileType {
	agentsMd = 'agentsMd',
	claudeMd = 'claudeMd',
	skipprInstructionsMd = 'skipprInstructionsMd',
}
...
export interface IPromptsService extends IDisposable {
	...
	/**
	 * Gets combined list of agent instruction files (AGENTS.md, CLAUDE.md, skippr-instructions.md).
	 * Combines results from listAgentMDs (non-nested), listClaudeMDs, and listSkipprInstructionsMDs.
	 */
