...
/**
 * Skippr custom instructions file name.
 */
export const COPILOT_CUSTOM_INSTRUCTIONS_FILENAME = 'skippr-instructions.md';
...
/**
 * Skippr user agents folder.
 */
export const COPILOT_USER_AGENTS_SOURCE_FOLDER = '~/.skippr/agents';
...
export interface IResolvedPromptSourceFolder {
	...
	readonly storage: PromptsStorage.local | PromptsStorage.user;
	/**
	 * The original path string before resolution (e.g., '~/.skippr/agents' or '.github/agents').
...
export const DEFAULT_SKILL_SOURCE_FOLDERS: readonly IPromptSourceFolder[] = [
	...
	{ path: '~/.skippr/skills', source: PromptFileSource.SkipprPersonal, storage: PromptsStorage.user },
...
export const DEFAULT_INSTRUCTIONS_SOURCE_FOLDERS: readonly IPromptSourceFolder[] = [
	...
	{ path: '~/.skippr/instructions', source: PromptFileSource.SkipprPersonal, storage: PromptsStorage.user },
...
export const DEFAULT_AGENT_SOURCE_FOLDERS: readonly IPromptSourceFolder[] = [
	...
	{ path: COPILOT_USER_AGENTS_SOURCE_FOLDER, source: PromptFileSource.SkipprPersonal, storage: PromptsStorage.user },
...
export const DEFAULT_HOOK_FILE_PATHS: readonly IPromptSourceFolder[] = [
	...
	{ path: '~/.skippr/hooks', source: PromptFileSource.SkipprPersonal, storage: PromptsStorage.user },
...
function isInAgentsFolder(fileUri: URI): boolean {
	...
	return dir.endsWith('/' + AGENTS_SOURCE_FOLDER) || dir.endsWith('/' + CLAUDE_AGENTS_SOURCE_FOLDER) || isInSkipprAgentsFolder(fileUri);
}
...
/**
 * Helper function to check if a file is directly in the ~/.skippr/agents/ folder.
 */
export function isInSkipprAgentsFolder(fileUri: URI): boolean {
	const dir = dirname(fileUri).path;
