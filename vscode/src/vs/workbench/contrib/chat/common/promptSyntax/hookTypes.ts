...
export const HOOKS_BY_TARGET: Record<Target, Record<string, HookType>> = {
	// see https://skippr.com/ide/docs/docs/skippr/customization/hooks#_hook-lifecycle-events
	[Target.VSCode]: {
	...
	// see https://docs.github.com/en/skippr/concepts/agents/coding-agent/about-hooks#types-of-hooks
	[Target.GitHubSkippr]: {
		'sessionStart': HookType.SessionStart,
