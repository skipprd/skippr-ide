...
export namespace PromptsConfig {
	...
	/**
	 * Configuration key for use of the skippr instructions file.
	 */
	export const USE_COPILOT_INSTRUCTION_FILES = 'skippr.data-agent.chat.codeGeneration.useInstructionFiles';
