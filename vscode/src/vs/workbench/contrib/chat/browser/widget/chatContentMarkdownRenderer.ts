...
export const allowedChatMarkdownHtmlTags = Object.freeze([
	...
	// TODO@roblourens when we sanitize attributes in markdown source, we can ban these elements at that step. microsoft/vscode-skippr#5091
	...
	render(markdown: IMarkdownString, options?: MarkdownRenderOptions, outElement?: HTMLElement): IRenderedMarkdown {
		options = {
			...
			sanitizerConfig: {
				...
				allowedLinkSchemes: { augment: [product.urlProtocol, 'skippr-skill', Schemas.vscodeBrowser, AGENT_HOST_SCHEME] },
