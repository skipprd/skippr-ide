	...
	},
	{
		...
		buildMessage() {
			return new MarkdownString(
				localize(
					'tip.skipprCli',
					"Run agents in parallel with [Skippr Agent](command:workbench.action.chat.openNewChatSessionInPlace.skipprcli?%5B%22sidebar%22%5D \"Switch to Skippr Agent\")."
				)
			);
		},
		when: ContextKeyExpr.and(
		...
		excludeWhenCommandsExecuted: ['workbench.action.chat.openNewChatSessionInPlace.skipprcli'],
	},
	{
