	...
	private updateSectionHeader(): void {
		...
		switch (this.currentSection) {
			case AICustomizationManagementSection.Agents:
				...
				docsUrl = 'https://skippr.com/ide/docs/docs/skippr/customization/custom-agents';
				learnMoreLabel = localize('learnMoreAgents', "Learn more about custom agents");
				break;
			case AICustomizationManagementSection.Skills:
				title = localize('skills', "Skills");
				description = localize('skillsDescription', "Folders of instructions, scripts, and resources that Skippr loads when relevant to perform specialized tasks.");
				docsUrl = 'https://skippr.com/ide/docs/docs/skippr/customization/agent-skills';
			...
			case AICustomizationManagementSection.Instructions:
				...
				docsUrl = 'https://skippr.com/ide/docs/docs/skippr/customization/custom-instructions';
			...
			case AICustomizationManagementSection.Hooks:
				...
				docsUrl = 'https://skippr.com/ide/docs/docs/skippr/customization/hooks';
			...
			default:
				...
				docsUrl = 'https://skippr.com/ide/docs/docs/skippr/customization/prompt-files';
	...
	private groupMatchedItems(matchedItems: IAICustomizationListItem[]): void {
		...
		const groups: { groupKey: string; label: string; icon: ThemeIcon; description: string; items: IAICustomizationListItem[] }[] =
			this.currentSection === AICustomizationManagementSection.Instructions
				? [
					{ groupKey: 'agent-instructions', label: localize('agentInstructionsGroup', "Agent Instructions"), icon: instructionsIcon, description: localize('agentInstructionsGroupDescription', "Instruction files automatically loaded for all agent interactions (e.g. AGENTS.md, CLAUDE.md, skippr-instructions.md)."), items: [] },
		...
		switch (this.currentSection) {
			...
			case AICustomizationManagementSection.Instructions:
				return {
					...
					description: localize('createFirstInstructions', "Add instructions to teach Skippr about your codebase"),
				};
			case AICustomizationManagementSection.Hooks:
				return {
