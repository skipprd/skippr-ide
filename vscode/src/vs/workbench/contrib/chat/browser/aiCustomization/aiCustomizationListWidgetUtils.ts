 ...
 * extensions like Skippr Data Agent that materialize prompt files under their
 * own globalStorage and register them via the prompt-file provider API.
 *
 * Returns the extension ID (e.g. `skippr.data-agent`) or `undefined`
...
export function extractExtensionIdFromPath(uriPath: string): string | undefined {
	...
	// e.g. "skippr.data-agent-0.43.2026040602" → "skippr.data-agent"
