...
export class RunTestTool implements IToolImpl {
	...
	public static readonly DEFINITION: IToolData = {
		...
		tags: [
			...
			'enable_other_tool_skippr_readFile',
			'enable_other_tool_skippr_listDirectory',
			'enable_other_tool_skippr_findFiles',
			'enable_other_tool_skippr_runTests',
			'enable_other_tool_skippr_runTestsWithCoverage',
...
export class TestFailureTool implements IToolImpl {
	...
	public static readonly DEFINITION: IToolData = {
		...
		legacyToolReferenceFullNames: ['skippr_testFailure'],
