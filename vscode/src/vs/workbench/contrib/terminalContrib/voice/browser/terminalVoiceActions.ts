...
export function registerTerminalVoiceActions() {
	registerActiveInstanceAction({
		...
		run: async (activeInstance, c, accessor) => {
			...
			const extension = extensions.find(extension => extension.identifier.id === 'skippr.vscode-speech');
			...
			if (extensionIsDisabled) {
				...
				run = () => commandService.executeCommand('workbench.extensions.installExtension', 'skippr.vscode-speech');
