...
suite('Workbench - TerminalUriLinkDetector', () => {
	...
	const linkComputerCases: [
		...
		/* Stat resource  */ URI?
			...
			[TerminalBuiltinLinkType.Url, '// Click here to learn more. https://skippr.com/go/fwlink/?LinkID=513275&clcid=0x409', [{ range: [[30, 1], [7, 2]], uri: URI.parse('https://skippr.com/go/fwlink/?LinkID=513275&clcid=0x409') }]],
			...
			[TerminalBuiltinLinkType.Url, '<!-- !!! Do not remove !!!   WebContentRef(link:https://skippr.com/go/fwlink/?LinkId=166007, area:Admin, updated:2015, nextUpdate:2016, tags:SqlServer)   !!! Do not remove !!! -->', [{ range: [[49, 1], [14, 2]], uri: URI.parse('https://skippr.com/go/fwlink/?LinkId=166007') }]],
			[TerminalBuiltinLinkType.Url, 'For instructions, see https://skippr.com/go/fwlink/?LinkId=166007.</value>', [{ range: [[23, 1], [68, 1]], uri: URI.parse('https://skippr.com/go/fwlink/?LinkId=166007') }]],
			...
			[TerminalBuiltinLinkType.Url, '請參閱 http://skippr.com/go/?LinkId=761051。', [{ range: [[8, 1], [48, 1]], uri: URI.parse('http://skippr.com/go/?LinkId=761051') }]],
			[TerminalBuiltinLinkType.Url, '（請參閱 http://skippr.com/go/?LinkId=761051）', [{ range: [[10, 1], [50, 1]], uri: URI.parse('http://skippr.com/go/?LinkId=761051') }]],
