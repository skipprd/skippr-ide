...
/** Skippr IDE: composite title toolbar (play + Skippr SelectBoxes). */
export const SKIPPR_RUN_TOOLBAR_COMMAND_ID = 'skippr.run.toolbar';
export const SKIPPR_RUN_TOOLBAR_CONTEXT_KEY = 'skippr.runToolbarInTitle';
...
export const DEBUG_CONFIGURE_LABEL = nls.localize2('openSkipprYamlConfig', 'Open Skippr &&configuration');
