...
// ============================================================================
// Realistic test data — a project that has Skippr + Claude customizations
// ============================================================================

const allFiles: IFixtureFile[] = [
	// Instructions - extension (built-in + third-party)
	{ uri: URI.file('/extensions/skippr.data-agent/instructions/coding.instructions.md'), storage: PromptsStorage.extension, type: PromptsType.instructions, name: 'Skippr Coding', description: 'Built-in coding guidance', extensionId: 'Skippr.data-agent', extensionDisplayName: 'Skippr Data Agent Chat' },
	...
	// Instructions — user
	{ uri: URI.file('/home/dev/.skippr/instructions/my-style.instructions.md'), storage: PromptsStorage.user, type: PromptsType.instructions, name: 'My Style', description: 'Personal coding style' },
	{ uri: URI.file('/home/dev/.skippr/instructions/typescript-rules.instructions.md'), storage: PromptsStorage.user, type: PromptsType.instructions, name: 'TypeScript Rules', description: 'Strict TypeScript conventions' },
	{ uri: URI.file('/home/dev/.skippr/instructions/commit-messages.instructions.md'), storage: PromptsStorage.user, type: PromptsType.instructions, name: 'Commit Messages', description: 'Conventional commit format' },
	...
	// Agents — user
	{ uri: URI.file('/home/dev/.skippr/agents/planner.agent.md'), storage: PromptsStorage.user, type: PromptsType.agent, name: 'Planner', description: 'Project planning agent' },
	{ uri: URI.file('/home/dev/.skippr/agents/debugger.agent.md'), storage: PromptsStorage.user, type: PromptsType.agent, name: 'Debugger', description: 'Interactive debugging assistant' },
	{ uri: URI.file('/home/dev/.skippr/agents/nls-helper.agent.md'), storage: PromptsStorage.user, type: PromptsType.agent, name: 'NLS Helper', description: 'Natural language searching code for clarity' },
	// Agents - extension (built-in + third-party)
	{ uri: URI.file('/extensions/skippr.data-agent/agents/workspace-guide.agent.md'), storage: PromptsStorage.extension, type: PromptsType.agent, name: 'Workspace Guide', description: 'Built-in workspace exploration agent', extensionId: 'Skippr.data-agent', extensionDisplayName: 'Skippr Data Agent Chat' },
	...
	// Skills — user
	{ uri: URI.file('/home/dev/.skippr/skills/git-workflow/SKILL.md'), storage: PromptsStorage.user, type: PromptsType.skill, name: 'Git Workflow', description: 'Branch and PR workflows' },
	{ uri: URI.file('/home/dev/.skippr/skills/code-review/SKILL.md'), storage: PromptsStorage.user, type: PromptsType.skill, name: 'Code Review', description: 'Structured code review checklist' },
	// Skills - extension (built-in + third-party)
	{ uri: URI.file('/extensions/skippr.data-agent/skills/workspace/SKILL.md'), storage: PromptsStorage.extension, type: PromptsType.skill, name: 'Workspace Search', description: 'Built-in workspace search skill', extensionId: 'Skippr.data-agent', extensionDisplayName: 'Skippr Data Agent Chat' },
	...
	// Prompts — user
	{ uri: URI.file('/home/dev/.skippr/prompts/translate.prompt.md'), storage: PromptsStorage.user, type: PromptsType.prompt, name: 'Translate', description: 'Translate strings for i18n' },
	{ uri: URI.file('/home/dev/.skippr/prompts/commit-msg.prompt.md'), storage: PromptsStorage.user, type: PromptsType.prompt, name: 'Commit Message', description: 'Generate conventional commit' },
	// Prompts - extension (built-in + third-party)
	{ uri: URI.file('/extensions/skippr.data-agent/prompts/trace.prompt.md'), storage: PromptsStorage.extension, type: PromptsType.prompt, name: 'Trace', description: 'Built-in tracing prompt', extensionId: 'Skippr.data-agent', extensionDisplayName: 'Skippr Data Agent Chat' },
	...
	// Hooks — user
	{ uri: URI.file('/home/dev/.skippr/hooks/daily-summary.json'), storage: PromptsStorage.user, type: PromptsType.hook, name: 'Daily Summary', description: 'Generate daily work summary' },
	{ uri: URI.file('/home/dev/.skippr/hooks/backup-changes.json'), storage: PromptsStorage.user, type: PromptsType.hook, name: 'Backup Changes', description: 'Auto-stash uncommitted changes' },
];
...
const agentInstructions: IAgentInstructionFile[] = [
	...
	{ uri: URI.file('/workspace/.github/skippr-instructions.md'), realPath: undefined, type: AgentInstructionFileType.skipprInstructionsMd },
];
...
const mcpRuntimeServers = [
	{ definition: { id: 'github-skippr-mcp', label: 'Skippr Data Agent' }, collection: { id: 'ext.skippr.data-agent/mcp', label: 'ext.skippr.data-agent/mcp' }, enablement: constObservable(2), connectionState: constObservable({ state: 2 }) },
];
		...
		additionalServices: (reg) => {
			...
			reg.defineInstance(IProductService, new class extends mock<IProductService>() {
				override readonly defaultChatAgent = new class extends mock<NonNullable<IProductService['defaultChatAgent']>>() {
					override readonly chatExtensionId = 'Skippr.data-agent';
				}();
			}());
		},
	});
...
const installedPlugins: IAgentPlugin[] = [
	makeInstalledPlugin('Linear', URI.file('/workspace/.skippr/plugins/linear'), true),
	makeInstalledPlugin('Sentry', URI.file('/workspace/.skippr/plugins/sentry'), true),
	makeInstalledPlugin('Datadog', URI.file('/workspace/.skippr/plugins/datadog'), true),
	makeInstalledPlugin('Notion', URI.file('/workspace/.skippr/plugins/notion'), true),
	makeInstalledPlugin('Confluence', URI.file('/workspace/.skippr/plugins/confluence'), true),
	makeInstalledPlugin('PagerDuty', URI.file('/workspace/.skippr/plugins/pagerduty'), false),
	makeInstalledPlugin('LaunchDarkly', URI.file('/workspace/.skippr/plugins/launchdarkly'), true),
	makeInstalledPlugin('CircleCI', URI.file('/workspace/.skippr/plugins/circleci'), true),
	makeInstalledPlugin('Vercel', URI.file('/workspace/.skippr/plugins/vercel'), false),
	makeInstalledPlugin('Supabase', URI.file('/workspace/.skippr/plugins/supabase'), true),
];
...
function makeMarketplacePlugin(name: string, description: string, repo: string): IMarketplacePlugin {
	return {
		...
		marketplaceType: MarketplaceType.Skippr,
	};
}
...
function makeInstalledPluginItem(name: string, description: string): IAgentPluginItem {
	return {
		...
		description,
		marketplace: 'GitHub',
		plugin: makeInstalledPlugin(name, URI.file(`/workspace/.skippr/plugins/${name.toLowerCase()}`), true),
	};
}
...
export default defineThemedFixtureGroup({ path: 'chat/aiCustomizations/' }, {
	...
	// Full editor with Skippr Agent harness — no prompts section, CLI-specific
	// root files and instruction filtering under .github/.skippr paths.
	CliHarness: defineComponentFixture({
		labels: { kind: 'screenshot' },
		render: ctx => renderEditor(ctx, { harnessId: SessionType.SkipprCLI, selectedSection: AICustomizationManagementSection.Agents }),
	}),
	...
	Sessions: defineComponentFixture({
		...
		render: ctx => renderEditor(ctx, {
			harnessId: SessionType.SkipprCLI,
