	...
	registry.registerConfiguration({
		...
		'properties': {
			'application.shellEnvironmentResolutionTimeout': {
				...
				'markdownDescription': localize('application.shellEnvironmentResolutionTimeout', "Controls the timeout in seconds before giving up resolving the shell environment when the application is not already launched from a terminal. See our [documentation](https://skippr.com/go/fwlink/?linkid=2149667) for more information.")
			}
		}
	});
