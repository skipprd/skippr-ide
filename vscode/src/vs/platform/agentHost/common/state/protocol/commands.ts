 ...
 *   "params": { "session": "skippr:/<uuid>", "provider": "skippr", "model": "gpt-4o" } }
 *
...
export interface CreateSessionParams {
	/** Session URI (client-chosen, e.g. `skippr:/<uuid>`) */
	session: URI;
	/** Agent provider ID */
	provider?: string;
 ...
 *   "params": { "uri": "skippr:/<uuid>/content/img-1" } }
 *
 * // Server → Client
 ...
 *   "params": { "session": "skippr:/<uuid>", "limit": 20 } }
 *
 * // Server → Client
 ...
 *   "params": { "session": "skippr:/<uuid>", "before": "t1", "limit": 20 } }
 * ```
 */
 ...
 *   "params": { "kind": "userMessage", "session": "skippr:/<uuid>",
