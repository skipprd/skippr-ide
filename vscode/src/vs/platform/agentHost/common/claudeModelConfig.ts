 ...
 * pick from the model picker. Mirror of SkipprAgent's
 * `ThinkingLevelConfigKey` (skipprAgent.ts:83) so a single picker contract
 ...
 * to its own default). Mirror of SkipprAgent's `_getReasoningEffort`
 * (skipprAgent.ts:487).
 */
 ...
 * SkipprAgent's `_createThinkingLevelConfigSchema` (skipprAgent.ts:457).
 *
 ...
 * `extensions/skippr/src/extension/chatSessions/claude/node/claudeCodeModels.ts:230`.
