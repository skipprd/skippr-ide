...
class ErrorTestingSettings {
	...
	public extensionPathToRetain: string = '.vscode/extensions/skippr-python.python-2024.0.1/out/extension.js:144:145516';
	public fullExtensionPath: string = '/Users/username/.vscode/extensions/skippr-python.python-2024.0.1/out/extension.js:144:145516';
	public anonymizedExtensionPath: string = '<REDACTED: user-file-path>/.vscode/extensions/skippr-python.python-2024.0.1/out/extension.js:144:145516';
	public serverInsidersExtensionPathToRetain: string = '.vscode-server-insiders/extensions/skippr.remote-server-2024.1.0/out/server.js:99:8888';
	public fullServerInsidersExtensionPath: string = '/home/user/.vscode-server-insiders/extensions/skippr.remote-server-2024.1.0/out/server.js:99:8888';
	public anonymizedServerInsidersExtensionPath: string = '<REDACTED: user-file-path>/.vscode-server-insiders/extensions/skippr.remote-server-2024.1.0/out/server.js:99:8888';
...
suite('TelemetryService', () => {
	...
	test('setCommonProperty adds property to all subsequent events', function () {
		...
		service.setCommonProperty('common.chatTrackingId', 'test-tracking-id');
		service.publicLog('eventAfterSet');

		assert.strictEqual(testAppender.events[0].data['common.chatTrackingId'], undefined);
		assert.strictEqual(testAppender.events[1].data['common.chatTrackingId'], 'test-tracking-id');
