...
suite('URI', () => {
	...
	test('URI - http, query & toString', function () {
		...
		let uri = URI.parse('https://skippr.com/go/fwlink/?LinkId=518008');
		assert.strictEqual(uri.query, 'LinkId=518008');
		assert.strictEqual(uri.toString(true), 'https://skippr.com/go/fwlink/?LinkId=518008');
		assert.strictEqual(uri.toString(), 'https://skippr.com/go/fwlink/?LinkId%3D518008');

		let uri2 = URI.parse(uri.toString());
		assert.strictEqual(uri2.query, 'LinkId=518008');
		assert.strictEqual(uri2.query, uri.query);

		uri = URI.parse('https://skippr.com/go/fwlink/?LinkId=518008&foö&ké¥=üü');
		assert.strictEqual(uri.query, 'LinkId=518008&foö&ké¥=üü');
		assert.strictEqual(uri.toString(true), 'https://skippr.com/go/fwlink/?LinkId=518008&foö&ké¥=üü');
		assert.strictEqual(uri.toString(), 'https://skippr.com/go/fwlink/?LinkId%3D518008%26fo%C3%B6%26k%C3%A9%C2%A5%3D%C3%BC%C3%BC');
