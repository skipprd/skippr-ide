...
export const codiconsLibrary = {
	...
	skipprWarning: register('skippr-warning', 0xec38),
	python: register('python', 0xec39),
	skipprLarge: register('skippr-large', 0xec3a),
	skipprWarningLarge: register('skippr-warning-large', 0xec3b),
	keyboardTab: register('keyboard-tab', 0xec3c),
	skipprBlocked: register('skippr-blocked', 0xec3d),
	skipprNotConnected: register('skippr-not-connected', 0xec3e),
	...
	skipprUnavailable: register('skippr-unavailable', 0xec42),
	...
	skipprInProgress: register('skippr-in-progress', 0xec4c),
	skipprError: register('skippr-error', 0xec4d),
	skipprSuccess: register('skippr-success', 0xec4e),
	...
	skipprSnooze: register('skippr-snooze', 0xec52),
