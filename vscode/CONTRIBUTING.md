...
Can you recreate the issue even after [disabling all extensions](https://skippr.com/ide/docs/docs/editor/extension-gallery#_disable-an-extension)? If you find the issue is caused by an extension you have installed, please file an issue on the extension's repo directly.
